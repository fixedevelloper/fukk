                ...
                <div className="container">
                  ...
                  ({product.reviews} avis)
                                    ...
                                    <div className="box-product-price mb-20">
                                        ...
                                        {product.oldPrice && (
                                            <span
                                                className="color-gray-500 price-line font-xl line-througt">${product.oldPrice} FCFA</span>
                                        )}
                                    </div>
                    ...
                    <span className="font-sm font-medium color-gray-900">
                      ...
                      Catégorie: <span
                        className="color-gray-500">{product.categories?.map(cat => cat.name).join(", ")}</span><br/>
                      Tags: <span
                        className="color-gray-500">{product.categories?.map(cat => cat.name).join(", ")}</span>
                    </span>
                                            </div>
                                            <div className="col-lg-6 col-md-6 mb-20">
                                          {/*      <ProductShopAttributes
                                                    attributes={product.attributes}
                                                    onChange={(selected) => {
                                                        console.log("Valeurs sélectionnées:", selected);
                                                    }}
                                                />
                                            ...
                                            <div className="col-lg-12 mb-20">
                                                <div className="d-inline-block">
                                                    <div className="share-link">
                                                        <span
                                                            className="font-md-bold color-brand-3 mr-15">Partager</span>
                                ...
                                <div className="col-md-5">
                                    <div className="box-border-product">
                                        ...
                                        <div className="button-buy mt-15">
                                            <a className="btn btn-cart mb-15" onClick={() => handleAddCart(product)}>Ajouter
                                                au panier</a>
                                            <Link className="btn btn-buy" onClick={() => handleAddCart(product)}
                                                  href="/shop/shop-checkout">Acheter maintenant</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
